...
* [Configuration](config/README.md)
    * [Configuration Files](config/config_files.en.md)
    * [Kylin Configuration](config/settings.en.md)
    ...
    * [JDBC Configuration](config/metadata_jdbc.en.md)
    * [Spark Dynamic Allocation](conf/spark_dynamic_allocation.en.md)
    * [JVM Configuration](config/jvm_settings.en.md)
    * [Mail Notification Settings](config/mail_settings.en.md)
...
* [SQL Query](query/README.md)
    ...
    * [Advanced SQL](query/adv_sql/README.md)
