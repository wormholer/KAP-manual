...
* [KAP安装](install/README.md)
    ...
    * [第一次安装KAP](install/README.md)
        * [必备条件](install/hadoop_env.cn.md)
        * [安装和启动](install/install.cn.md)
        * [部署方式](install/deploy.cn.md)
            * [单节点部署-CDH](quickstart/quickstart_hdp.cn.md)
            * [单节点部署-HDP](quickstart/quickstart_cdh.cn.md)
            * [多节点部署]()
            * [云端部署](quickstart/quickstart_azure.cn.md)
    ...
    * [KAP配置](config/README.md)
        ...
        * [生产环境推荐配置](config/recommend_settings_v2_1.cn.md)
...
* [建模场景](molap/README.md)
    ...
    * [建模优化](optimization/README.md)
        ...
        * [Count Distinct查询](optimization/count_distinct.cn.md)
        * [Count Distinct精确查询](optimization/count_distinct_precise.cn.md)
