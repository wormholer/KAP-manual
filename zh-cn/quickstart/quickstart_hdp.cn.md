...
1. 针对HDP2.2，找到YARN-Configs，修改*yarn.nodemanager.resource.memeory-mb*为*4096*，*yarn.scheduler.maximum-allocation-mb*为*4096*；针对HDP2.4，找到YARN-Configs->Settings，修改*Memory Node*为*4096M*
